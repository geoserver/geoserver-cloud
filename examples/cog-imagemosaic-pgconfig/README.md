...
This example requires GeoServer Cloud 2.28.4.0 or later. That release adds
...
The compose file defaults the GeoServer Cloud images to `2.28.4-SNAPSHOT`,
...
```bash
export GSCLOUD_VERSION=2.28.4.0
```
...
starting with GeoServer Cloud 2.28.4.0. On an earlier release, the mosaic
