...
public class CloudGeoServerSecurityManager extends GeoServerSecurityManager {
    ...
    private List<GeoServerAuthenticationProvider> additionalAuthenticationProviders;
    ...
    public CloudGeoServerSecurityManager(
            ...
            @NonNull List<GeoServerAuthenticationProvider> additionalAuthenticationProviders)
            throws Exception {
        super(dataDir);
