...
/**
 * Configuration properties for GeoServer Web UI modules. Maps to all {@code @ConditionalOnProperty} conditions used in
 * web-ui auto-configurations.
 */
@Data
...
public class WebUIConfigurationProperties {
    ...
    /** Security UI configuration. (Maps to {@code geoserver.web-ui.security}). */
    @NestedConfigurationProperty
    private ComponentConfig security = new ComponentConfig();

    /** WFS UI configuration. (Maps to {@code geoserver.web-ui.wfs}). */
    @NestedConfigurationProperty
    private ComponentConfig wfs = new ComponentConfig();

    /** WMS UI configuration. (Maps to {@code geoserver.web-ui.wms}). */
    @NestedConfigurationProperty
    private ComponentConfig wms = new ComponentConfig();

    /** WCS UI configuration. (Maps to {@code geoserver.web-ui.wcs}). */
    @NestedConfigurationProperty
    private ComponentConfig wcs = new ComponentConfig();

    /** WPS UI configuration. (Maps to {@code geoserver.web-ui.wps}). */
    @NestedConfigurationProperty
    private ComponentConfig wps = new ComponentConfig();

    /** GWC UI configuration. (Maps to {@code geoserver.web-ui.gwc}). */
    @NestedConfigurationProperty
    private GwcConfig gwc = new GwcConfig();

    /** ACL UI configuration. (Maps to {@code geoserver.web-ui.acl}). */
    @NestedConfigurationProperty
    private ComponentConfig acl = new ComponentConfig();

    /** File browser UI configuration. (Maps to {@code geoserver.web-ui.file-browser}). */
    @NestedConfigurationProperty
    ...
    public static class Demos {
        /** Flag to enable/disable demos UI. (Maps to {@code geoserver.web-ui.demos.enabled}). */
        private boolean enabled = true;

        /** Flag to enable/disable WPS request builder. (Maps to {@code geoserver.web-ui.demos.wps-request-builder}). */
        private boolean wpsRequestBuilder = true;

        /** Flag to enable/disable WCS request builder. (Maps to {@code geoserver.web-ui.demos.wcs-request-builder}). */
        private boolean wcsRequestBuilder = true;

        /** Flag to enable/disable demo requests. (Maps to {@code geoserver.web-ui.demos.demo-requests}). */
        private boolean demoRequests = true;

        /** Flag to enable/disable SRS list. (Maps to {@code geoserver.web-ui.demos.srs-list}). */
        private boolean srsList = true;

        /**
         * Flag to enable/disable reprojection console. (Maps to {@code geoserver.web-ui.demos.reprojection-console}).
         */
        private boolean reprojectionConsole = true;

        /** Layer preview configuration. (Maps to {@code geoserver.web-ui.demos.layer-preview-page}). */
        @NestedConfigurationProperty
        ...
        public static class LayerPreviewPageConfig {
            /**
             * Flag to enable/disable layer preview page. (Maps to
             * {@code geoserver.web-ui.demos.layer-preview-page.enabled}).
             */
            private boolean enabled = true;

            /**
             * Layer preview common formats configuration. (Maps to
             * {@code geoserver.web-ui.demos.layer-preview-page.common-formats}).
             */
            @NestedConfigurationProperty
            ...
            public static class CommonFormatsConfig {
                /**
                 * Flag to enable/disable OpenLayers common format. (Maps to
                 * {@code geoserver.web-ui.demos.layer-preview-page.common-formats.open-layers}).
                 */
                private boolean openLayers = true;

                /**
                 * Flag to enable/disable GML common format. (Maps to
                 * {@code geoserver.web-ui.demos.layer-preview-page.common-formats.gml}).
                 */
                private boolean gml = true;

                /**
                 * Flag to enable/disable KML common format. (Maps to
                 * {@code geoserver.web-ui.demos.layer-preview-page.common-formats.kml}).
                 */
    ...
    public static class Tools {
        /** Flag to enable/disable tools UI. (Maps to {@code geoserver.web-ui.tools.enabled}). */
        private boolean enabled = true;

        /** Flag to enable/disable resource browser. (Maps to {@code geoserver.web-ui.tools.resource-browser}). */
        private boolean resourceBrowser = true;

        /**
         * Flag to enable/disable catalog bulk load tool. (Maps to {@code geoserver.web-ui.tools.catalog-bulk-load}).
         */
        private boolean catalogBulkLoad = true;

        /**
         * Flag to enable/disable reprojection console. (Maps to {@code geoserver.web-ui.tools.reprojection-console}).
         */
        private boolean reprojectionConsole = true;
    }

    /**
     * Returns whether the class name from a wicket bookmarkable page URL should be enabled or hidden. E.g. for
     * {@code org.geoserver.wms.web.WMSAdminPage} from
     * {@code /web/wicket/bookmarkable/org.geoserver.wms.web.WMSAdminPage?filter=false}, will return {@code false} if
     * {@link #wms} is disabled.
     */
