...
/**
 * Annotation that marks a component to be conditional on the application being a GeoServer WFS (Web Feature Service)
 * application.
 *
 * <p>This annotation is used to selectively enable components that should only be active in GeoServer WFS applications.
 * It verifies that:
 *
 * <ul>
 *   <li>The application has GeoServer core classes ({@link ConditionalOnGeoServer})
 *   <li>The WFS service class is available in the classpath
 *   <li>The {@code geoserver.service.wfs.enabled} property is set to {@code true}
 * </ul>
 *
