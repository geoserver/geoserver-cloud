...
/** Test suite for {@link ParquetryGeoParquetOutputFormatAutoConfiguration} */
class ParquetryGeoParquetOutputFormatAutoConfigurationTest {

    private static final String PREFIX = "geoserver.extension.tileverse.parquetry";
    private static final String FORMAT = "geoParquetOutputFormat";
    private static final String STATUS = "geoParquetWfsOutputFormatModuleStatus";

    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withBean("geoServer", GeoServer.class, GeoServerImpl::new)
            .withConfiguration(AutoConfigurations.of(
                    ParquetryAutoConfiguration.class, ParquetryGeoParquetOutputFormatAutoConfiguration.class));
    ...
    void formatAbsentWhenFeatureIsOff() {
        wfsRunner
                .withPropertyValues(PREFIX + ".output-formats.geoparquet.enabled=false")
    ...
    void formatPresentWhileSiblingFeaturesAreOff() {
        wfsRunner
                .withPropertyValues(
                        PREFIX + ".parquet.enabled=false", PREFIX + ".output-formats.arrow-ipc.enabled=false")
