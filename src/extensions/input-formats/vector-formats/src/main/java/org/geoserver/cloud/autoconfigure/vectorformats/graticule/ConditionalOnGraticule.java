 ...
 *
 * <ul>
 *   <li>The geoserver.extension.graticule.enabled property is true (the default)
 * </ul>
 *
 * <p>This annotation can be used on configuration classes or bean methods to make them conditional on Graticule being
 * enabled.
 *
