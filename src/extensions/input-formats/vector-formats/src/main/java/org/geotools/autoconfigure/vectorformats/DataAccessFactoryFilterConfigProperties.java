...
/**
 * Configuration properties to control which GeoTools DataAccessFactory implementations are enabled or disabled.
 *
 * <p>Example:
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>This configuration allows for fine-grained control over which data store factories are available within the
 * application, using user-friendly display names with placeholder resolution. Note that factory names containing
 * special characters should be properly escaped with the format "[Factory Name]".
 */
...
public class DataAccessFactoryFilterConfigProperties {
    ...
    /**
     * Map of factory display names to their enabled status. Keys are the user-friendly display names of
     * DataAccessFactory implementations. Values are boolean flags indicating whether the factory is enabled (true) or
     * disabled (false).
     */
     ...
     * @return true if the factory is explicitly enabled or not present in the configuration
     */
