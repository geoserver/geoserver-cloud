 ...
 *   <li>The geoserver.extension.vector-tiles.geojson property is true (the default)
 * </ul>
 *
 * <p>This annotation can be used on configuration classes or bean methods to make them conditional on the GeoJSON
