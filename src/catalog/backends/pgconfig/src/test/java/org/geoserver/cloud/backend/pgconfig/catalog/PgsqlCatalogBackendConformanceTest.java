...
class PgsqlCatalogBackendConformanceTest extends CatalogConformanceTest {
    ...
    protected CatalogImpl createCatalog(File tmpFolder) {
        ...
        PgsqlResourceStore resourceStore =
        ...
        var resourceLoader = new PgsqlGeoServerResourceLoader(resourceStore);
        CatalogPlugin catalog = new PgsqlBackendBuilder(container.getDataSource()).createCatalog();
