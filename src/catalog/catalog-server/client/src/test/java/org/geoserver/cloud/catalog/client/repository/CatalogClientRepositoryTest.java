...
class CatalogClientRepositoryTest {
    ...
    @Test void workspaceRepository_DefaultWorkspace() {
    ...
    @Test void namespaceRepository_DefaultNamespace() {
    ...
    @Test void storeRepository_CRUD() {
    ...
    @Test void storeRepository_GetDefaultDataStore() {
    ...
    @Test void storeRepository_SetDefaultDataStore() {
    ...
    @Test void storeRepository_GetDefaultDataStores_Empty() {
    ...
    @Test void storeRepository_GetDefaultDataStores() {
    ...
    @Test void resourceRepository_CRUD() {
    ...
    @Test void testFindByNameNullType() {
