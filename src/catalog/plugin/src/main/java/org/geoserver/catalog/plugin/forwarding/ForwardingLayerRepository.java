 ...
 *
 * <p>This class extends {@link ForwardingCatalogRepository} to wrap a {@link LayerRepository} subject, delegating all
 * operations related to {@link LayerInfo} management. It enables subclasses to override specific methods to customize
...
public class ForwardingLayerRepository extends ForwardingCatalogRepository<LayerInfo, LayerRepository>
     ...
     *
     * @param subject The underlying {@link LayerRepository} to forward calls to; may be null (behavior depends on
     *     subclass).
     */
