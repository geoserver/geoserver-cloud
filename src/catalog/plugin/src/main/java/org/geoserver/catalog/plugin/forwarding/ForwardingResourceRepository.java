 ...
 *
 * <p>This class extends {@link ForwardingCatalogRepository} to wrap a {@link ResourceRepository} subject, delegating
 * all operations related to {@link ResourceInfo} management. It enables subclasses to override specific methods to
...
public class ForwardingResourceRepository extends ForwardingCatalogRepository<ResourceInfo, ResourceRepository>
     ...
     *
     * @param subject The underlying {@link ResourceRepository} to forward calls to; may be null (behavior depends on
     *     subclass).
     */
