...
public class LiteralDto extends ExpressionDto {

    private Object value;

    public static LiteralDto valueOf(Object value) {
        return value instanceof LiteralDto l ? l : new LiteralDto().setValue(value);
    }

    @Override
    public boolean equals(Object o) {
        if (o instanceof LiteralDto other) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(LiteralDto.class, value);
    }
}
