...
/**
 * Temporary measure until <a href="https://osgeo-org.atlassian.net/browse/GEOT-6717">GEOT-6717</a>
 * is fixed. Can't extent {@link CapabilitiesFilterSplitter} because wouldn't be able to access its
 * private member variables.
 */
@SuppressWarnings({"rawtypes", "unchecked"})
public class CapabilitiesFilterSplitterFix implements FilterVisitor, ExpressionVisitor {
    /** This is the problematic method, see GEOT-6717 */
    public Object visit(Function expression, Object notUsed) {
        ...
        for (int k = 0; k < expression.getParameters().size(); k++) {
            /// GEOT-6717 easy fix, .get(k) instead of .get(i)
    ...
    private static final Logger LOGGER =
            org.geotools.util.logging.Logging.getLogger(CapabilitiesFilterSplitterFix.class);
     ...
     */
    public CapabilitiesFilterSplitterFix(
