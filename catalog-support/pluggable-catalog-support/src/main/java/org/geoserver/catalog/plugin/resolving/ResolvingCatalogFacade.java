...
public class ResolvingCatalogFacade extends ForwardingRepositoryCatalogFacade {
    ...
    public ResolvingCatalogFacade(ExtendedCatalogFacade facade) {
        super(facade);
    }
    ...
    protected <C extends CatalogInfo> C resolveOutbound(C info) {
        Function<C, C> outboundResolve = outbound();
        return outboundResolve.apply(info);
    }

    protected <C extends CatalogInfo> C resolveInbound(C info) {
